...
def dnn_model(x_train, y_train, x_test, y_test, activation, last_activation, learning_rate, cost_function, batch_size, num_of_iterations, dims_of_layers):
...
dnn_model(x_train, y_train, x_test, y_test, "relu", "softmax", learning_rate = 0.01, cost_function = "cross_entropy", batch_size = 108, num_of_iterations = 1000, dims_of_layers = [input_dim, 16, 16, output_dim])
